...
model_letters = keras.models.load_model("../models/model_letter")
model_words = keras.models.load_model("../models/model_word")
face_cascade = cv2.CascadeClassifier('../models/haarcascade_frontalface_default.xml')

def set_letters_model_dir(path)
    """
    Function to set model path for letter detection.
    :param path: path to the directory containing the saved_model.pb file
    """
    model_letters = keras.models.load_model(path)
    
def set_words_model_path(path)
    """
    Function to set model path for word detection.
    :param path: path to the directory containing the saved_model.pb file
    """
