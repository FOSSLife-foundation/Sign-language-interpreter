...
import numpy as np
import keras
model_letters = keras.models.load_model("../models/model_5")
print(model_letters.summary())
model_words = keras.models.load_model("../models_words/model_2")
...
words = ['_switch', 'name', 'i', 'hello', 'learn', 'yes', 'no', 'brother', 'you', 'who', 'what', 'when', 'where', 'why', 'how', 'which']
